...
final class TexyListModule extends TexyModule
{
	...
	// @ TBD: Find out - why in beforeParse() and not in the constructor?
	...
	public function patternDefList($parser, $matches)
	{
		...
		// event listener
		// @ BUG? Should this $mod be the <dl>'s one?
	...
	// @ TODO: Optimize not to create Patterns all around.
	//         Move that `while` (from which is this called) to a new method.
	/**
	...
	public function patternItem($parser, $bullet, $indented, $tag)
	{
		...
		// @ WTF?  Maybe it's to prevent <p> inside <li>. TODO!
