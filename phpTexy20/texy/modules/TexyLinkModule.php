...
final class TexyLinkModule extends TexyModule
{
	...
	public function patternReference($parser, $matches)
	{
        ...
        /* @ Search for a predefined link, see Texy constructor for example */
	...
	/**
	 * @param  string Target of the link (like the href part)
	 * @param  string Modifier in the text representation
	 * @param  string Label for the link
	 * @return TexyLink
     * @ Link Factory. Filled param comments.
     *
	 */
    ...
    /* @ Internal named reference. */
		// [ref]                    // @ Refactor - duplicated if checks.
		...
		elseif (strlen($dest)>1 && $dest{0} === '[' && $dest{1} === '*') {
  		...
  		// @ TODO: Refactor - some link-provider carried by the event object.
