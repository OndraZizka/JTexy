...
public class SimpleImageSize
{
	private int height;
	private int width;
	private String mimeType;

	public SimpleImageSize(File file) throws IOException {
	...
	public SimpleImageSize(InputStream is) throws IOException {
		processStream(is);
	}

	public SimpleImageSize(byte[] bytes) throws IOException {
