...
public class AboutBox extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(cz.dynawest.jtexy.sandbox.swing.SwingSandboxApp.class).getContext().getResourceMap(AboutBox.class);
    setTitle(resourceMap.getString("title")); // NOI18N
    setModal(true);
    setName("aboutBox"); // NOI18N
    setResizable(false);

    javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(cz.dynawest.jtexy.sandbox.swing.SwingSandboxApp.class).getContext().getActionMap(AboutBox.class, this);
